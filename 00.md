...
Each ORE is identified by a number (e.g. `ORE-00`, `ORE-01`). OREs are either **mandatory** or **optional**. Mandatory OREs MUST be implemented by all compliant providers. Optional OREs MAY be implemented and, if implemented, MUST be implemented within the bounds specified.
